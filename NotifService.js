...
export default class NotifService {
  ...
  createDefaultChannels() {
    PushNotification.createChannel(
      {
        channelId: "ariniku-channel", // (required)
        channelName: `ariniku-channel`, // (required)
        channelDescription: "ariniku-channel", // (optional) default: undefined.
      ...
      (created) => console.log(`createChannel 'ariniku-channel' returned '${created}'`) // (optional) callback returns whether the channel was created, false means it already existed.
    );
    // PushNotification.createChannel(
    //   {
    //     channelId: "ariniku-channel", // (required)
  ...
  localNotifWithParam(soundName, from, subtext, title, bigtext) {
    this.lastId++;
    PushNotification.localNotification({
      /* Android Only Properties */
      channelId: soundName ? 'sound-channel-id' : 'default-channel-id',
      ticker: from, // (optional)
      autoCancel: true, // (optional) default: true
      ...
      userInfo: { screen: 'Chat' }, // (optional) default: {} (using null throws a JSON value '<null>' error)
